...
def AvatarStickyMittenSegmentationColorsStart(builder): builder.StartObject(3)
...
def AvatarStickyMittenSegmentationColorsAddEnvId(builder, envId): builder.PrependInt32Slot(1, envId, 0)
def AvatarStickyMittenSegmentationColorsAddBodyParts(builder, bodyParts): builder.PrependUOffsetTRelativeSlot(2, tdw.flatbuffers.number_types.UOffsetTFlags.py_type(bodyParts), 0)
