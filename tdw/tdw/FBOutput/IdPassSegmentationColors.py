...
def IdPassSegmentationColorsStart(builder): builder.StartObject(4)
...
def IdPassSegmentationColorsAddEnvId(builder, envId): builder.PrependInt32Slot(2, envId, 0)
def IdPassSegmentationColorsAddSegmentationColors(builder, segmentationColors): builder.PrependUOffsetTRelativeSlot(3, tdw.flatbuffers.number_types.UOffsetTFlags.py_type(segmentationColors), 0)
